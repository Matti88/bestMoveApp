...
const HeroTop = () => {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid max-w-md grid-cols-1 mx-auto lg:grid-cols-12 gap-x-6 gap-y-8 lg:max-w-none">
            <div className="self-center lg:col-span-4">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 sm:text-4xl xl:text-5xl">
                Welcome to bestMove 🏠 Search and find the best location
              </h1>
              <p className="mt-5 text-base font-normal leading-7 text-gray-500 dark:text-gray-300">
                Use our advanced calculations to find the best house or apartment for you.
              </p>
              ...
              <div className="mt-6 space-y-6 lg:space-y-8">
                <div className="relative overflow-hidden">
                  <div className="flex items-start lg:items-center">
                    ...
                    <p className="ml-5 text-base font-bold leading-6 text-gray-900 dark:text-gray-100">
                      <a href="#" title="">
                        Access to the exact location of thousands of listings
